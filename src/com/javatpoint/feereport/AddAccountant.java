...
public static boolean signUp(String name, String password, String email, String contactno ) {
    	
    	try{  
    		Class.forName("com.mysql.jdbc.Driver");
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/feereport","root","qi.nak.K287UFCW");    
            Statement s =con.createStatement();  
            String query = "Select * from feereport_accountant where name = '"+name+"' and password = '"+password+"' and email = '"+email+"' and contactno = '"+contactno+"'";
